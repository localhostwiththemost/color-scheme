      ...
      fetch(
        ...
        .then((data) => {
          ...
          <div class="hex"><p>${data.colors[0].hex.value}</p></div>
                <div class="hex"><p>${data.colors[1].hex.value}</p></div>
                <div class="hex"><p>${data.colors[2].hex.value}</p></div>
                <div class="hex"><p>${data.colors[3].hex.value}</p></div>
                <div class="hex"><p>${data.colors[4].hex.value}</p></div>
               </div>
                `;
        });
    });
